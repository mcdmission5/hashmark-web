...
const VERSION = "hashmark-v30";   // v30: NIL Economy (tier board + efficiency + methodology) + premium depth (heat grid, crowd-vs-model, player cards, seed histograms, roster economy)
const SHELL = [
  "./",
  "./index.html",
