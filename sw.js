...
const VERSION = "hashmark-v61";   // v61: U28 - bubbles up + News & Standings bubbles   // v60: U27 - honest lookahead watch (board + scores strip)   // v56: U11+U31 - recruiting Commits/Prospects/News sub-tabs + portal News (ungated)
const SHELL = [
  "./",
  "./index.html",
