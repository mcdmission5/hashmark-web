...
const VERSION = "hashmark-v35";   // v35: batch 8 - NIL 2025 performance board, SWR cache + parallel winprob + skeletons, PREVIEW_UNLOCK, shared tiles, away-banner, signature gauge cards
const SHELL = [
  "./",
  "./index.html",
