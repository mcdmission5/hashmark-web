...
const VERSION = "hashmark-v57";   // v57: U26 - Talent Bomb widened (top-25 talent, bottom-60% margin, up to 8)   // v56: U11+U31 - recruiting Commits/Prospects/News sub-tabs + portal News (ungated)
const SHELL = [
  "./",
  "./index.html",
