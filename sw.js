...
const VERSION = "hashmark-v34";   // v34: batch 7 - picker scroll/ranks/change-team, team-page accordion order + 2026 swap, 12-game gauntlet, schedule-to-matchup teaser, What-Wins tile + gating
const SHELL = [
  "./",
  "./index.html",
